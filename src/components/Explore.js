  ...
  useGSAP(() => {
    gsap.to('#exploreVideo', {
      scrollTrigger: {
        ...
        onEnter: () => exploreRef.current.play(),
        onEnterBack: () => exploreRef.current.play(),
      },
    });
        ...
        <div className="flex flex-row px-[10vw] gap-[2vw] mb-[20vh] mt-[5vh]">
          <div className="flex flex-col">
            <div className="h-[82vh] w-[38vw] bg-black relative">
              <img src={explore1Img} className="opacity-0 pr-[4vw] absolute" id="img1" alt="" />
            </div>
          ...
          <div className="flex flex-col">
            <div className="h-[88vh] w-[40vw] bg-black content-center">
              <img src={explore2Img} className="opacity-0 px-[2vw]" id="img2" alt="" />
            </div>
            <div className="pt-[14vh] font-semibold text-white text-xl ml-[6vw] mr-[10vw] opacity-0" id="exploreh2">
              <p>
                Titanium has one of the best strength‑to‑weight ratios of any metal, making these our lightest Pro models
                ever. You’ll notice the difference the moment you pick one up.
              </p>
            </div>
          </div>
        </div>
